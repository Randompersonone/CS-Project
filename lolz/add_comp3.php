...
if(isset($_POST['submit'])) {
  ...
  if(count($errors)==0) {
    ...
    if(!$q || mysqli_num_rows($q)==0){
      $sql10="SELECT mining_id FROM mining";
      ...
      $arrid=array();
		if($q)
		{
			...
			{
				$num = preg_replace('/[^0-9]/', '', $x["mining_id"]);
	...
	$sql4="INSERT INTO mining(mining_id,c_name,price,bid,offer,open_) VALUES('$idog','$name','$open1','$bid','$offer','$open1');";
	$sql5="UPDATE mining SET market_capital=price*'$pub';";
