...
if(isset($_POST['submit'])) {
  ...
  if(count($errors)==0) {
    ...
    if(!$q || mysqli_num_rows($q)==0){
      $sql10="SELECT const_id FROM construction";
      ...
      $arrid=array();
		if($q)
		{
			...
			{
				$num = preg_replace('/[^0-9]/', '', $x["const_id"]);
	...
	$sql4="INSERT INTO construction(const_id,c_name,price,bid,offer,open_) VALUES('$idog','$name','$open1','$bid','$offer','$open1');";
	$sql5="UPDATE construction SET market_capital=price*'$pub';";
	$sql6="UPDATE companies SET change=open-price;";
	$sql7="UPDATE companies SET p_change=(change/price)*100;";
  $sql8="INSERT INTO admin VALUES('$admin','$name','$adminid','$adminp');";
