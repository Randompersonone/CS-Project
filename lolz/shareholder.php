...
<p style="float: right; padding-right: 8px;margin-top: 15px; margin-bottom: 0px;  font-size: 20px;">Welcome <strong><?php echo $_SESSION["username"]; ?></strong></p>
  <?php if(isset($_SESSION['success'])){
  	...
  	$sql= "SELECT * FROM shareholders WHERE loginID='$identity';";
...
<div>
	...
	<hr>
	<h4><pre>Shares Name:		      <?php echo $x["shares_name"]?></pre></h4>
	<hr>
	<h4><pre>Gain/Loss 				<?php echo $x["gain_loss"]?></pre></h4>
	<hr>
  <h4><pre>Current balance:         <?php echo $x["curr_balance"]?></pre></h4>
	<hr>
<?php }?>
	<hr>
</div>
