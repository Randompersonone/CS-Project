...
<body style="background-color:#e0e0e0;">
  ...
  <br>
<p style="float: right; padding-right: 8px;margin-top: 15px; margin-bottom: 0px;  font-size: 20px;" align="left">Welcome <strong><?php echo $_SESSION["username"]; ?></strong></p>
<div class="container">
  <div class="card">
  <?php if(isset($_SESSION['success'])): ?>
<br><br><br>
  <h2 align="center"><font color="green">Check your personal stock information</font></h2><br><br>
    <div class="form-group" align="center">
      <table class="w3_table_trade">
        <tr>
      <th><label for="addr" >Please choose:</label><br><br></th></tr>
      <tr><td><a href="user_balance.php">User balance</a><br><br></td></tr>
      <tr><td><a href="total_shares.php">Total Shares</a><br><br></td></tr>
      <tr><td><a href="shareholder.php">Shareholder details</a><br><br></td></tr>
       <tr><td><a href="compdetails.php">View company details</a><br><br></td></tr>
      <tr><td><a href="buystock.php">Buy Stocks</a><br><br></td></tr>
      <tr><td><a href="deleteuser.php">Delete Account</a><br><br></td></tr>
      <tr><td><a id="a" href="user1.php" name="logout">LOGOUT</a></p></td></tr>
    </table>
