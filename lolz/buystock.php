...
<div class="container">
  ...
  <form action="buy.php" method="post">
    <div class="form-group">
      <label for="compname">Enter the name of the company:</label>
      <input type="text" class="form-control" required="required" id="id" placeholder="Enter Company name" name="compname">
      <label for="compname">Enter number of stocks to be bought:</label>
      <input type="number" class="form-control" required="required" id="id" placeholder="Enter number of stocks" name="stock">
