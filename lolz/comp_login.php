...
<p style="float: right; padding-right: 8px;margin-top: 15px; margin-bottom: 0px;  font-size: 20px;">Welcome <strong><?php echo $_SESSION["cname"]; $_SESSION["ogid"]; ?></strong></p>
<div class="container">
  <?php if(isset($_SESSION['success'])): ?>

  <h2>Check your personal stock information</h2>
  <form action="customer.php" method="post">
    <div class="form-group" align="center">
      <label for="addr" >Please choose:</label><br>
      <a href="user_balance.html">User balance</a><br><br>
      <a href="total_shares.html">Total Shares</a><br><br>
      <a href="shareholder.html">Shareholder details</a><br><br>
