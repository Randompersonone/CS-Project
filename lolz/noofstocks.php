...
<html>
<head>
	<title>Update number of stocks</title>
...
<div class="container">
  <h2>Number of stocks</h2>
    <div class="form-group">
      ...
      <label for="compname">Enter the nuumber of stocks:</label>
      <input type="number" class="form-control" required="required" id="id" placeholder="Enter number of stocks" name="no">
  </div>
  <div class="form-group">
