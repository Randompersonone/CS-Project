...
<p style="float: right; padding-right: 8px;margin-top: 15px; margin-bottom: 0px;  font-size: 20px;"><pre>Welcome Admin:<strong><?php echo $_SESSION["username"]; ?></strong>     Company:<strong><?php echo $_SESSION["cname"]; ?></strong></pre></p>
<div class="container">
  <?php if(isset($_SESSION['success'])): ?>

  <h2>Option to modify your Company</h2>
    <div class="form-group" align="center">
      <label for="addr" >Please choose:</label><br>
      <a href="transaction.php">View Transaction Logs</a><br><br>
      <a href="changedetails.php">Change details</a><br><br>
      <a href="deletecomp.php">Delete Company</a><br><br>
      <a id="a" href="user1.php" name="logout">LOGOUT</a></p>
