...
if(isset($_POST['submit'])) {
  ...
  if(count($errors)==0) {
    ...
    if(!$q || mysqli_num_rows($q)==0){
      $sql10="SELECT cf_id FROM consultancy_firms";
	...
	$sql4="INSERT INTO consultancy_firms(cf_id,c_name,price,bid,offer,open_) VALUES('$idog','$name','$open1','$bid','$offer','$open1');";
	$sql5="UPDATE consultancy_firms SET market_capital=price*'$pub';";
