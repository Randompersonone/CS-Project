...
<div class="container">
  ...
  <hr>
  <h4 align="center">Company Type Selected : Oil</h4>
  <hr>
  <form action="add_comp1.php" method="post">
    <div class="form-group">
      <label for="pub_share" >Name of the company</label>
      <input type="text" class="form-control" required="required" id="pub_share" placeholder="Enter the name" name="name">
    </div>
    <div class="form-group">
      <label for="pub_share" >Total number of shares open to the public:</label>
      <input type="number" class="form-control" required="required" id="pub_share" placeholder="Enter the number of shares open to the public" name="pub_share">
    </div>
    <div class="form-group">
      <label for="open" >Opening price:</label>
      <input type="number" class="form-control" required="required" id="open" placeholder="Enter the opening price" name="open">
    </div>
    <div class="form-group">
      <label for="offer" >Offer price:</label>
      <input type="number" class="form-control" required="required" id="offer" placeholder="Enter the offer price" name="offer">
    </div>
    <div class="form-group">
      <label for="bid" >Bid price:</label>
      <input type="number" class="form-control" required="required" id="bid" placeholder="Enter the bid price" name="bid">
    </div>
    <div class="form-group">
      <label for="addr" >Select company type:</label><br><br>
      <input type="radio" name="company_type" value="statutory">statutory<br>
      <input type="radio" name="company_type" value="registered">registered<br>
      <input type="radio" name="company_type" value="chartered">chartered<br>
    </div>
