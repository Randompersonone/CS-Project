...
<div class="container">
<h2>Company fields of <?php echo $_SESSION["comp"]; ?></h2>
<div>
	<h4><pre>Opening Price(new day): 		        <?php echo $_SESSION["o"]; ?></pre></h4>
	<hr>
	<h4><pre>Price(current price): 				  <?php echo $_SESSION["p"]; ?></pre></h4>
	<hr>
	<h4><pre>Change in price: 				          <?php echo $_SESSION["c"]; ?></pre></h4>
	<hr>
  <h4><pre>Percentage Change in price:                   <?php echo $_SESSION["per"]; ?></pre></h4>
  <hr>
  <h4><pre>Bid Price:                   <?php echo $_SESSION["b"]; ?></pre></h4>
  <hr>
</div>
<p style="float: right; padding-right: 8px;margin-top: 15px; margin-bottom: 0px;  font-size: 20px;"><a href="buystock.php"><strong>Go back</a></strong></p>
</body>
